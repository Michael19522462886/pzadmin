 ...
 * @LastEditTime: 2024-10-07 14:54:31
 * @FilePath: \accompany\pzadmin\src\components\aside.vue
...
<template>
    ...
    class="el-menu-vertical-demo aside-container "
...
let active = computed(() => store.state.menu.menuActive)
// console.log(router,"!!!")
